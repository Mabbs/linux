...
export declare const MachineTerminationReason: {
    readonly Clean: 0;
    readonly Panic: 1;
};
/** Values for the kernel.terminate_machine guest/host ABI. */
export type MachineTerminationReason = (typeof MachineTerminationReason)[keyof typeof MachineTerminationReason];
